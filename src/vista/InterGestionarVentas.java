...
public class InterGestionarVentas extends javax.swing.JInternalFrame {
    ...
    private void buscarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/ventas.txt"))) {
            String linea;
    ...
    private void eliminarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/ventas.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("resources/ventas_temp.txt"))) {
            ...
            if (encontrado) {
                JOptionPane.showMessageDialog(this, "Data de venta eliminada exitosamente.", "Información", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Data de venta no encontrada.", "Información", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        new java.io.File("resources/ventas.txt").delete();
        new java.io.File("resources/ventas_temp.txt").renameTo(new java.io.File("resources/ventas.txt"));
    }
    ...
    private void verTodosLosProductos() {
        try (BufferedReader br = new BufferedReader(new FileReader("resources/ventas.txt"))) {
            ...
            JOptionPane.showMessageDialog(this, productos.toString(), "Todas las Ventas", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error al leer el archivo.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        jButton_ver_productos.setText("Ver todas las ventas");
