...
public class InterGestionarUsuarios extends javax.swing.JInternalFrame {
    ...
    private void buscarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/InfoUsuarios.txt"))) {
            String linea;
            StringBuilder producto = new StringBuilder();
            boolean encontrado = false;

            while ((linea = br.readLine()) != null) {
                if (linea.contains("ID: " + nombreBuscado)) {
                    encontrado = true;
            ...
            if (encontrado) {
                JOptionPane.showMessageDialog(this, producto.toString(), "Usuario Encontrado", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    private void eliminarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/InfoUsuarios.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("resources/InfoUsuarios_temp.txt"))) {
        ...
        new java.io.File("resources/InfoUsuarios.txt").delete();
        new java.io.File("resources/InfoUsuarios_temp.txt").renameTo(new java.io.File("resources/InfoUsuarios.txt"));
    }
    ...
    private void verTodosLosProductos() {
        try (BufferedReader br = new BufferedReader(new FileReader("resources/InfoUsuarios.txt"))) {
            ...
            JOptionPane.showMessageDialog(this, productos.toString(), "Todos los Usuarios", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error al leer el archivo.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        jButton_ver_productos.setText("Ver todos los usuarios");
