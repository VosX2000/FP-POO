...
public class InterGestionarProducto extends javax.swing.JInternalFrame {
    ...
    private void buscarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/productos.txt"))) {
            String linea;
            ...
            if (encontrado) {
                JOptionPane.showMessageDialog(this, producto.toString(), "Producto Encontrado", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    private void eliminarProducto() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/productos.txt"));
             BufferedWriter bw = new BufferedWriter(new FileWriter("resources/productos_temp.txt"))) {
        ...
        new java.io.File("resources/productos.txt").delete();
        new java.io.File("resources/productos_temp.txt").renameTo(new java.io.File("resources/productos.txt"));
    }
    ...
    private void verTodosLosProductos() {
        try (BufferedReader br = new BufferedReader(new FileReader("resources/productos.txt"))) {
            ...
            JOptionPane.showMessageDialog(this, productos.toString(), "Todos los Productos", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error al leer el archivo.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        jButton_ver_productos.setText("Ver todos los productos");
